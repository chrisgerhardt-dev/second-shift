...
| File | Live URL |
| --- | --- |
| `index.html` | https://beaconcpa.com/ |
| `contact.html` | https://beaconcpa.com/contact-us/ |

Images, theme CSS, and JS needed for the mirrored pages use **relative**
paths so project Pages works.

Uncloned deep links stay on `https://beaconcpa.com/...`.

## Dummy forms

Every `<form>` is neutralized. Nothing posts to Beacon CPA.
