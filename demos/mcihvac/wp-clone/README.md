...
| File | Live URL |
| --- | --- |
| `index.html` | https://www.mcihvac.com/ |
| `contact.html` | https://www.mcihvac.com/contact |

Images, theme CSS, and JS needed for the mirrored pages use **relative**
paths so project Pages works.

Uncloned deep links stay on `https://www.mcihvac.com/...`.

## Dummy forms

Every `<form>` is neutralized. Nothing posts to MCI.
