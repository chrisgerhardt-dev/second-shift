...
Clone `ready: true` points at the live URL. Western Mechanical Refresh and Reimagine are published. Kaback Refresh is published (`https://kaback-refresh.webflow.io/`, `ready: true`); Kaback Reimagine stays parked. Other firms’ Refresh / Reimagine stay `ready: false` until Webflow publishes.
