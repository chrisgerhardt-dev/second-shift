...
- Ready tiers restore stored Stripe buy/desk CTAs (Refresh $4k, Reimagine $6k, desk $750).
...
No email send except the authorized Clone-only draft after a human confirms. No DNS change. No paid spend. No merge from the agent.
